    ...
    <section className="py-20 bg-gray-50">
      <div className="container-custom">
        <div className="text-center mb-10">
          <span className="text-brand-600 font-semibold text-sm uppercase tracking-wider">📍 Eksploroni Shqipërinë</span>
          <h2 className="section-title mt-2">Oferta sipas Qytetit</h2>
          <p className="section-subtitle mx-auto mt-3">Gjeni oferta të mrekullueshme kudo në Shqipëri</p>
        </div>
            ...
            >
              <Link to={`/city/${city.name.toLowerCase()}`}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 text-white">
                  ...
                  <p className="text-xs text-white/80">{city.deals} oferta</p>
                </div>
              </Link>
            </motion.div>
          ))}
