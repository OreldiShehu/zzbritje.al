export default function Privacy() {
  const sections = [
    ...
    { title: '3. Ndarja e të Dhënave', content: 'Nuk i shesim të dhënat tuaja personale. Mund t\'i ndajmë me: bizneset partnere (vetëm për qëllime të voucher-it), ofruesit e shërbimeve (Stripe, Cloudinary, Twilio) sipas nevojës teknike, dhe autoritetet nëse kërkohet me ligj.' },
