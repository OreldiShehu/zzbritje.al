    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          { label: 'Komisione', value: formatCurrency(summary.commission || 0), icon: DollarSign, color: 'text-brand-400', bg: 'bg-brand-900/20' },
            ...
            <table className="w-full min-w-[700px]">
              <thead>
                <tr className="border-b border-gray-700">
                  {['Invoice', 'Klienti', 'Deal', 'Shuma', 'Komision', 'Metoda', 'Data', 'Statusi', 'Veprime'].map((h) => (
